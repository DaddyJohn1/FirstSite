...
<body>	
		<div class="mybody">
			...
			<form action="q9.php" method="POST">
				<ol class="question">
					<li value="8" style="font-weight: bold;">____of what Sarah said was not correct.</li>
					<input class="option" type="radio" name="option" value="A" onclick="enabled()">(a) Little <br>
					<input class="option" type="radio" name="option" value="B" onclick="enabled()">(b) More <br>
					<input class="option" type="radio" name="option" value="C" onclick="enabled()">(c) Most <br>
					<input class="option" type="radio" name="option" value="D" onclick="enabled()">(d) Much <br>
				</ol>
