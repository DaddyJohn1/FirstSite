...
<body>	
		<div class="mybody">
			...
			<form action="q6.php" method="POST">
				<ol class="question">
					<li value="5" style="font-weight: bold;">The little girl ran _____ the road.</li>
					<input class="option" type="radio" name="option" value="A" onclick="enabled()">(a) Across <br>
					<input class="option" type="radio" name="option" value="B" onclick="enabled()">(b) At <br>
					<input class="option" type="radio" name="option" value="C" onclick="enabled()">(c) By <br>
					<input class="option" type="radio" name="option" value="D" onclick="enabled()">(d) Over <br>
				</ol>
