...
<body>	
		<div class="mybody">
			...
			<form action="q7.php" method="POST">
				<ol class="question">
					<li value="6" style="font-weight: bold;">Mr. Yinka travelled to India_______air.</li>
					<input class="option" type="radio" name="option" value="A" onclick="enabled()">(a) By <br>
					<input class="option" type="radio" name="option" value="B" onclick="enabled()">(b) In <br>
					<input class="option" type="radio" name="option" value="C" onclick="enabled()">(c) On <br>
					<input class="option" type="radio" name="option" value="D" onclick="enabled()">(d) With <br>
				</ol>
